...
- [The automation sweep sends record ids to the orchestrator, and decides nothing itself](docs/adr/2026-09-22-the-automation-sweep-sends-record-ids-to-the-orchestrator-and-decides.md) — 2026-09-22-the-automation-sweep-sends-record-ids-to-the-orchestrator-and-decides [accepted]
<!-- ADR:INDEX:END -->
