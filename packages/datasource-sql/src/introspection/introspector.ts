...
export default class Introspector {
  ...
  static getIntrospectionInLatestFormat(
    ...
    const formattedIntrospection: Required<Introspection> = Array.isArray(introspection)
      ? {
          tables: introspection,
          version: this.FORMAT_VERSION,
          source: this.SOURCE,
        }
      : // Backwards compatibility with old introspection format
        { source: this.SOURCE, ...introspection };

    if (formattedIntrospection.source !== this.SOURCE) {
      throw new Error(
