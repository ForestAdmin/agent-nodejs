...
// What kind of failure a step error is. All four cross the wire even though only 'operator' drives
...
export const ErrorKindSchema = z.enum(['operator', 'configuration', 'system', 'empty-source']);
