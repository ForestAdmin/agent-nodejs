...
export default createMockContext({
  method: 'GET',
  url: '/forest/post/100/relationships/comments?timezone=Europe%2FParis&fields%5Bcomment%5D=body%2Cemail%2Cid%2Cname%2Cpost&fields%5Bpost%5D=id&page%5Bnumber%5D=1&page%5Bsize%5D=15&sort=-id',
  state: { user },
});
