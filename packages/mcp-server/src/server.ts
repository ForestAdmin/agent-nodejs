...
export default class ForestMCPServer {
  ...
  private async setupTools(): Promise<void> {
    ...
    declareAssociateTool(this.mcpServer, this.forestServerUrl, this.logger, collectionNames);
    declareDissociateTool(this.mcpServer, this.forestServerUrl, this.logger, collectionNames);
